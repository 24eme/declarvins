<!-- #popup_ajout_produit_AOP -->
<div id="popup_ajout_produit_AOP" class="popup_contenu popup_ajout_produit">
	<form method="post" action="../ajax.php?action=ajout_produit&type=AOP" id="subForm" class="popup_form">
