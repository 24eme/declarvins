<!-- #popup_ajout_produit_IGP -->
<div id="popup_ajout_produit_IGP" class="popup_contenu popup_ajout_produit">
	<form method="post" action="../ajax.php?action=ajout_produit&type=IGP" id="subForm" class="popup_form">
