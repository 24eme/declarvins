<!-- #popup_ajout_produit_VINSSANSIG -->
<div id="popup_ajout_produit_VINSSANSIG" class="popup_contenu popup_ajout_produit">
	<form method="post" action="../ajax.php?action=ajout_produit&type=VINSSANSIG" id="subForm" class="popup_form">
		...
		<div class="ligne_form">
			<label for="produit_couleur">Couleur*: </label>
			<select id="produit_couleur" name="produit[couleur]">
...
<!-- fin #popup_ajout_produit_VINSSANSIG -->