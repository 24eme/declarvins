...
<?php require('../includes/header.php'); ?>
	...
	<section id="contenu">
		...
		<section id="principal">
			<div id="application_dr">
				<ul id="onglets_principal">
					...
					<li class="ajouter"><a href="#" class="btn_popup" data-popup="#popup_ajout_appelation" data-popup-titre="Ajouter une appelation">Ajouter Appelation</a></li>
				</ul>
					...
					<div id="colonnes_dr">
						...
						<div id="col_saisies">
							...
							<div id="col_saisies_cont">
								<?php for($num_col = 1; $num_col < 6; $num_col++) { ?>
								...
								<div id="col_recolte_<?php echo $num_col; ?>" class="col_recolte">
									<form action="../ajax.php?action=valider_col" method="post">
										...
										<h2>
											Nom <?php echo $num_col; ?>
											<!--<select data-val-defaut="blanc" name="<?php echo $col_id; ?>-couleur">
										...
										<div class="col_cont">
											<p class="label">
												...
												<!--
												<select data-val-defaut="biodynamie" name="<?php echo $col_id; ?>-label[]" multiple="multiple" size="5">
													<option value="biodynamie">biodynamie</option>
													<option value="label_2">label 2</option>
													<option value="label_3">label 3</option>
													<option value="label_4">label 4</option>
													<option value="label_5">label 5</option>
												</select>
												-->
											</p>
										
											<div class="groupe" data-groupe-id="1">
												<p><input type="text" value="200" data-val-defaut="200" class="num num_float somme_stock_debut" id="<?php echo $col_id; ?>-1" name="<?php echo $col_id; ?>-1" readonly="readonly" /></p>
												<ul>
													<?php for($j = 1; $j < 4; $j++) { ?>
		...
		<?php require('../includes/_popup_ajout_appelation.php'); ?>
	</section>
	<!-- fin #contenu -->
