    ...
    <div id="rub_contrats">
        <section id="principal"> 
            <div id="recap_saisie" class="popup_form visualisation_contrat">
				...
				<?php endif; ?>
				<form action="<?php echo url_for('vrac_validation', array('contrat' => $vrac->numero_contrat, 'etablissement' => $etablissement, 'acteur' => $acteur)) ?>" method="post" id="vrac_condition">
