<form method="post" action="<?php echo url_for(array('sf_route' => 'compte_partenaire_modification', 'login' => $form->getObject()->login)); ?>">
    ...
    <div class="ligne_form reinit_mdp">
        <a href="<?php echo url_for('partenaire_compte_password', array('login' => $form->getObject()->login)) ?>" class="btn_orange" style="float: right;">Envoyer une demande de redéfinition de mot de passe</a>
    </div>
