...
<section id="contenu">
	<div id="creation_compte">
		...
		<?php if ($sf_user->hasFlash('success')) : ?>
            ...
            <br />
		<?php endif; ?>
		<p class="txt-espace">Vous allez recevoir un email à l'adresse : <strong><?php echo $compte->email ?></strong> contenant la convention CIEL des douanes, à renvoyer signée par courrier à votre service des douanes habituels.</p>
