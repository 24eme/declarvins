<section id="contenu">
	...
	<p>
	Vous tentez de vous connecter à la plateforme <a href="<?php echo url_for('ac_vin_login') ?>">Declarvins.net</a>. avec un compte qui n'existe pas<?php if ($compte): ?> (<?php echo $compte ?>)<?php endif; ?>.<br />
