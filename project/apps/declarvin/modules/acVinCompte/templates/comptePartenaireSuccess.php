<section id="contenu">
	...
	Vous tentez de vous connecter à la plateforme <a href="<?php echo url_for('ac_vin_login') ?>">Declarvins.net</a> réservée aux déclarant avec votre compte partenaire EDI.<br />
