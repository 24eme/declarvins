...
<div id="application_dr" class="clearfix">
	...
	<div id="compteModification">
		<div class="societe">
            ...
            <div class="ligne_form">
                        <label>&nbsp;</label>
                        <?php echo $formSociete[$sf_user->getCompte()->getGerantInterpro()->_id]->renderError() ?>
            </div>
			<div class="ligne_form">
					<label>Code comptable société :</label>
					<?php echo $formSociete[$sf_user->getCompte()->getGerantInterpro()->_id]->render(array('style' => 'width: 120px;text-align:right;')) ?>
