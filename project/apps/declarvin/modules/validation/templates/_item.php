<tr<?php if ($i%2): ?> class="alt"<?php endif;?>>
	<td>
		<a href="<?php echo url_for("validation_suppression", array('num_contrat' => $compte->key[CompteMandatsView::KEY_NUMERO_CONTRAT])) ?>" class="supprimer" style="left: 5px;" onclick="return confirm('Confirmez-vous la suppression du contrat mandat n°<?php echo $compte->key[CompteMandatsView::KEY_NUMERO_CONTRAT] ?> ?')">Supprimer</a>
