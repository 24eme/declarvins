		...
		<tbody>
			<tr>
				<td>
					...
					<br>
					<select id="produit_definition_droit_cvo_${index}_date_day" name="produit_definition[droit_cvo][${index}][date][day]">
						<option value=""></option>
					...
					<select id="produit_definition_droit_cvo_${index}_date_month" name="produit_definition[droit_cvo][${index}][date][month]">
						<option value=""></option>
						<option value="1">01</option>
						<option value="2">02</option>
						<option value="3">03</option>
					...
					<select id="produit_definition_droit_cvo_${index}_date_year" name="produit_definition[droit_cvo][${index}][date][year]">
						<option value=""></option>
