...
<tr>
	...
	<td><a href="<?php echo url_for('produit_modification', array('noeud' => 'mention', 'hash' => str_replace('/', '-', $produit->key[8]))) ?>" class="btn_edit btn_popup1" data-popup="popup_produit" data-popup-config="configForm"><?php echo ($produit->key[4])? $produit->key[4] : 'Défaut' ?></a></td>
