...
<nav id="barre_navigation">
    ...
    <ul id="actions_etablissement">
        ...
        <li class="etablissement_courant"><a href="" title="<?=$sf_user->getTiers()->getDenomination()?>"><span><?php echo truncate_text($sf_user->getTiers()->getDenomination(),28); ?></span></a></li>
