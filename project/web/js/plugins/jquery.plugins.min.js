 ...
 ******************************************/
(function(a){a.inputPlaceholder=function(b){if(!Modernizr.input.placeholder){if(!b)b=a('input:text[placeholder!=""][value=""]');b.each(function(){var b=a(this);var c=b.attr("placeholder");b.val(c);b.focus(function(){if(b.val()==c)b.val("")});b.blur(function(){if(b.val()=="")b.val(c)})})}}})(jQuery);
