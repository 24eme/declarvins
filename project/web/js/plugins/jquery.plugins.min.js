 ...
 ******************************************/
(function(a){a.inputPlaceholder=function(b){if(!Modernizr.input.placeholder){if(!b)b=a('input:text[placeholder!=""]').filter(function(){return this.value == '';});b.each(function(){var b=a(this);var c=b.attr("placeholder");b.val(c);b.focus(function(){if(b.val()==c)b.val("")});b.blur(function(){if(b.val()=="")b.val(c)})})}}})(jQuery);



/**
 * Rollover d'un �l�ment
 * $(s).survolElem
	({
		classe: 'hover',
		ie6: false
...
/**
 * Transforme une cha�ne de caract�res en objet JS
 * $.unserialize(s);
 ******************************************/
...
/**
 * Retourne les param�tres d'une URL
 * URL de la page par d�faut
 * $.getURLParam(url);
 ******************************************/
...
/**
 * Met � jour une URL avec des nouveaux 
 * param�tres
...
/**
 * G�re le remplacement d'image au survol
