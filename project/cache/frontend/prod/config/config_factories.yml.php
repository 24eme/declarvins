...
// date: 2011/09/13 17:14:30
  ...
  'cache_dir' => '/data/declarweb/project/cache/frontend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/data/declarweb/project/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/data/declarweb/project/cache/frontend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/data/declarweb/project/apps/frontend/template',
)));
