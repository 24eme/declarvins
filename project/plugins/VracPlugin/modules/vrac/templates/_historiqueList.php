<table>
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo ($vrac[VracHistorique::VIEW_INDEX_ACTIF])? 'Actif' : 'Apuré'; ?></td>
			<td><a href="<?php echo url_for('vrac_switch', array('id' => $vrac[VracHistorique::VIEW_INDEX_ID], 'annee' => $vrac[VracHistorique::VIEW_INDEX_ANNEE]))?>"><?php echo (!$vrac[VracHistorique::VIEW_INDEX_ACTIF])? 'Réactiver' : 'Apurer'; ?></a></td>
		</tr>
		<?php endforeach; ?>
	</tbody>
</table>
