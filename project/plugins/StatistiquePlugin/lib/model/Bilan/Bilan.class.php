...
class Bilan extends BaseBilan {
    ...
    public function updateEtablissement($etablissement = null) {
        ...
        $this->etablissement->add('famille', $etablissement->famille);
        $this->etablissement->add('sous_famille', $etablissement->sous_famille);
    }
    ...
    public function updateFromDRM($drm, $isFirstCampagne = false) {
        ...
        $periodeNode->add('mode_de_saisie', $drm->mode_de_saisie);
