...
class StatistiqueVracFilterForm extends StatistiqueFilterForm
{
	...
	public function configure() 
	{
        ...
        $this->setWidget('vendeur.code_postal', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $choices)));
        ...
        $this->setWidget('acheteur.code_postal', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $choices)));
        ...
        $this->setWidget('vendeur.famille', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $familleChoices)));
        $this->setWidget('vendeur.sous_famille', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $sousFamilleChoices)));
        ...
        $this->setWidget('acheteur.famille', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $familleChoices)));
        $this->setWidget('acheteur.sous_famille', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $sousFamilleChoices)));
        ...
        $this->setWidget('prix_unitaire', new sfWidgetFormDateRange(array(
            ...
            'template'      => '<br /><span class="delimiteur_date">de</span> %from_date%<br /><span class="delimiteur_date">à</span> %to_date%'
        )));
        ...
        $this->setWidget('cas_particulier', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $choices)));
        ...
        $this->setWidget('labels', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $choices)));
        ...
        $this->setWidget('mentions', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $choices)));
        ...
        $this->setWidget('type_prix', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $choices)));
        ...
        $this->setWidget('type_transaction', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'multiple' => true, 'expanded' => true, 'choices' => $choices)));
        ...
        $this->setWidget('annexe', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'expanded' => true, 'choices' => $choices)));
		...
		// EXPORT
		$choices = $this->getChoixOuiNon();
        $this->setWidget('export', new sfWidgetFormChoice(array('renderer_options' => array('label_separator' => null), 'expanded' => true, 'choices' => $choices)));
