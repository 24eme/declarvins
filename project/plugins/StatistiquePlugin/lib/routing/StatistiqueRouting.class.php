...
class StatistiqueRouting {
    ...
    static public function listenToRoutingLoadConfigurationEvent(sfEvent $event) {
        ...
        $r->prependRoute('statistiques_drm_manquantes_csv', new sfRoute('/admin/statistiques/:interpro/drm-manquantes/:campagne/:periode', array('module' => 'statistique', 'action' => 'bilanDrmManquantesCsv', 'interpro' => null, 'campagne' => null)));
        
        $r->prependRoute('statistiques_demat_drm', new sfRoute('/admin/statistiques/demat-drm', array('module' => 'statistique', 'action' => 'dematDrm')));
