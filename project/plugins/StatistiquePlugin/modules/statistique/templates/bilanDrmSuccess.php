                            ...
                            foreach ($statistiquesBilan->getBilans() as $bilanOperateur):
                                ...
                                <tr>
                                    ...
                                    foreach ($statistiquesBilan->getPeriodes() as $periode):
                                        ...
                                        <td style="padding: 0;">
                                            <strong>
                                             <?php echo (is_null($bilanOperateur->periodes[$periode]))? array_search(DRMClient::DRM_STATUS_BILAN_NON_SAISIE, $statusArray) : array_search($bilanOperateur->periodes[$periode]->statut, $statusArray); ?>
                                            </strong>
                                        </td>
                                        <?php
                                    endforeach;
