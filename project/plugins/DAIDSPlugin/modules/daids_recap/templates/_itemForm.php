        ...
        <div class="col_cont">
			...
			<div class="groupe" data-groupe-id="1">
				<p class="total_chais <?php echo isVersionnerCssClass($form->getObject(), 'stock_chais') ?>">
					<?php echo $form['stock_chais']->render(array('class' => 'texte total_chais', 'data-champs' => '#'.$form['stocks']['chais']->renderId().';#'.$form['stocks']['propriete_tiers']->renderId(), 'data-calcul' => 'somme', 'data-val-defaut' => sprintFloat($form->getObject()->stock_chais, "%01.04f"))) ?>
				</p>
				<ul>
					<li class="<?php echo isVersionnerCssClass($form->getObject()->stocks, 'chais') ?>"><?php echo $form['stocks']['inventaire_chais']->render(array('class' => 'num num_float', 'autocomplete' => 'off', 'data-liaison' => '#'.$form['stocks']['physique_chais']->renderId().';#'.$form['stocks']['chais']->renderId(), 'data-val-defaut' => sprintFloat($form->getObject()->stocks->chais, "%01.04f"))) ?></li>
			...
			<div class="groupe" data-groupe-id="2">
				<p class="total_propriete <?php echo isVersionnerCssClass($form->getObject(), 'stock_propriete') ?>">
					<?php echo $form['stock_propriete']->render(array('class' => 'texte total_propriete', 'data-champs' => '#'.$form['stocks']['chais']->renderId().';#'.$form['stocks']['tiers']->renderId(), 'data-calcul' => 'somme', 'data-val-defaut' => sprintFloat($form->getObject()->stock_propriete, "%01.04f"))) ?>
				</p>
				<ul>
					<li class="<?php echo isVersionnerCssClass($form->getObject()->stocks, 'chais') ?>"><?php echo $form['stocks']['physique_chais']->render(array('class' => 'num num_float', 'autocomplete' => 'off', 'data-liaison' => '#'.$form['stocks']['inventaire_chais']->renderId().';#'.$form['stocks']['chais']->renderId(), 'data-val-defaut' => sprintFloat($form->getObject()->stocks->chais, "%01.04f"))) ?></li>
			...
			<p class="total_manq_exce <?php echo isVersionnerCssClass($form->getObject(), 'total_manquants_excedents') ?>">
				<?php echo $form['total_manquants_excedents']->render(array('class' => 'texte total_manq_exce', 'data-champs' => '#'.$form['stock_chais']->renderId().';#'.$form['stock_theorique']->renderId(), 'data-calcul' => 'diff', 'data-val-defaut' => sprintFloat($form->getObject()->total_manquants_excedents, "%01.04f"))) ?>
	        </p>
			...
			<div class="groupe" data-groupe-id="4">
				...
				<ul id="choix_radio_<?php echo $form->getObject()->renderId() ?>_1" class="choix_radio">
					...
					<li>
						<?php echo $form['stocks_moyen']['vinifie']['total']->render(array('data-radio-name' => '#choix_radio_'.$form->getObject()->renderId().'_1', 'class' => 'texte', 'data-calcul' => 'produit_radio', 'data-champs' => '#'.$form['stocks_moyen']['vinifie']['volume']->renderId(), 'data-val-defaut' => sprintFloat($form->getObject()->stocks_moyen->vinifie->total, "%01.04f"))) ?>
					</li>
				</ul>
			</div>
			...
			<div class="groupe" data-groupe-id="5">
				<p class="<?php echo isVersionnerCssClass($form->getObject()->stocks_moyen->non_vinifie, 'volume') ?>">
					<?php echo $form['stocks_moyen']['non_vinifie']['volume']->render(array('class' => 'texte', 'data-calcul' => 'diff', 'data-champs' => '#'.$form['stock_mensuel_theorique']->renderId().';#'.$form['stocks_moyen']['vinifie']['volume']->renderId(), 'data-val-defaut' => sprintFloat($form->getObject()->stocks_moyen->non_vinifie->volume, "%01.04f"))) ?>
				</p>
				<ul>
			...
			<div class="groupe" data-groupe-id="6">
				...
				<ul>
					<li class="<?php echo isVersionnerCssClass($form->getObject()->stocks_moyen->conditionne, 'total') ?>">
						<?php echo $form['stocks_moyen']['conditionne']['total']->render(array('class' => 'texte', 'data-calcul' => 'produit', 'data-champs' => '#'.$form['stocks_moyen']['conditionne']['volume']->renderId().';#'.$form['stocks_moyen']['conditionne']['taux']->renderId(), 'data-val-defaut' => sprintFloat($form->getObject()->stocks_moyen->conditionne->total, "%01.04f"))) ?>
					</li>
				</ul>
			</div>
			<?php endif; ?>
			<p class="<?php echo isVersionnerCssClass($form->getObject(), 'total_pertes_autorisees') ?>">
				<?php $dataChamps = (isset($form['stocks_moyen']['conditionne']))? '#'.$form['stocks_moyen']['vinifie']['total']->renderId().';#'.$form['stocks_moyen']['non_vinifie']['total']->renderId().';#'.$form['stocks_moyen']['conditionne']['total']->renderId() : '#'.$form['stocks_moyen']['vinifie']['total']->renderId().';#'.$form['stocks_moyen']['non_vinifie']['total']->renderId(); ?>
			...
			<p class="<?php echo isVersionnerCssClass($form->getObject(), 'total_manquants_taxables') ?>">
				<?php echo $form['total_manquants_taxables']->render(array('class' => 'texte inverse_value not_null_value', 'data-champs' => '#'.$form['total_pertes_autorisees']->renderId().';#'.$form['total_manquants_excedents']->renderId(), 'data-calcul' => 'somme', 'data-val-defaut' => sprintFloat($form->getObject()->total_manquants_taxables, "%01.04f"))) ?>
			</p>
