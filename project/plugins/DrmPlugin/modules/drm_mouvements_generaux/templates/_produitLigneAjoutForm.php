<form id="subForm" action="<?php echo url_for('@drm_mouvements_generaux_product_form') ?>" method="post">
	...
	<table>
		...
		<tr><td><?php echo $form['label_supplementaire']->renderLabel() ?></td><td><?php echo $form['label_supplementaire']->render() ?></td><td><span class="error"><?php echo $form['label_supplementaire']->renderError() ?></span></td></tr>
