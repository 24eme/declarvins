        ...
        <?php if ($appellation->getKey() == $config_appellation->getKey()): ?>
            <li class="actif">
                <strong>
                    ...
                    <span class="completion completion_validee">(0/<?php echo $appellations[$appellation_key] ?>)</span>
                </strong>
            </li>
        <?php else: ?>
            <li>
                <a href="<?php echo url_for('drm_recap_appellation', $appellation) ?>">
                    <?php echo $appellation->libelle ?> 
                    <span class="completion">(0/<?php echo $appellations[$appellation_key] ?>)</span>
                </a>
            </li>
        <?php endif; ?>
    <?php endforeach; ?>
