<ul id="onglets_principal">
    <?php foreach ($appellation_keys as $appellation_key): ?>
        ...
        <?php endif; ?>
    <?php endforeach; ?>
    <li class="ajouter"><a class="btn_popup" data-popup="#popup_ajout_appelation" data-popup-ajax="true" data-popup-config="configAjoutAppellation" href="<?php echo url_for('drm_recap_appellation_ajout_ajax', $config_appellation->getCertification()) ?>">Ajouter une appellation</a></li>
</ul>
