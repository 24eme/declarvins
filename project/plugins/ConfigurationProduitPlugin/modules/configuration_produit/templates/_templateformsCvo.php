		...
		<tbody>
			<tr>
				<td>
					...
					<label for="produit_definition_noeud_droits_cvo_${index}_date">Date: </label>
					<br>
				...
				<td>
					<span class="error"></span>
					<label for="produit_definition_noeud_droits_cvo_${index}_code">Code: </label>
					<br>
					<input type="text" id="produit_definition_noeud_droits_cvo_${index}_code" name="produit_definition[noeud_droits_cvo][${index}][code]">
				</td>
				<td>
					<span class="error"></span>
					<label for="produit_definition_noeud_droits_cvo_${index}_libelle">Libelle: </label>
					<br>
				...
				<td>
					<span class="error"></span>
					<label for="produit_definition_noeud_droits_cvo_${index}_taux">Taux: </label>
					<br>
