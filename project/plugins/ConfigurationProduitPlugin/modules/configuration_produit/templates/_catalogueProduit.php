<div class="tableau_ajouts_liquidations">
    	...
    	?>
			...
			<td><a href="<?php echo url_for('configuration_produit_modification', array('noeud' => 'cepage', 'hash' => str_replace('/', '-', $produit->getHash()))) ?>" class="btn_edit btn_popup1" data-popup="popup_produit" data-popup-config="configForm"><?php echo $produit->getCepageLibelle(); ?></a><br /><p style="font-size: 85%; text-align:center;"><?php echo $produit->inao ?><?php if (!$produit->inao): ?><?php echo $produit->libelle_fiscal ?><?php endif; ?></p></td>
