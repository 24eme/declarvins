...
class acVinRouting
{
  ...
  static public function listenToRoutingLoadConfigurationEvent(sfEvent $event)
  {
    ...
    $r->prependRoute('ac_vin_compte_viticonnect_api', new sfRoute('/viticonnect/api/:login/:epoch/:md5', array('module' => 'acVinCompte', 'action' => 'viticonnectApi'), array(), array('segment_separators' => ['/'])));
  }
}
