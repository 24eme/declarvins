...
<?php if ($etab): ?>
L'entreprise <?php if($etab->nom) { echo $etab->nom; } if($etab->raison_sociale) { echo ($etab->nom)? ' / '.$etab->raison_sociale : $etab->raison_sociale; } echo ($etab->famille)? ' - '.ucfirst($etab->famille) : ''; ?> a annulé le contrat numéro <?php echo $vrac->numero_contrat; ?> vous concernant.<br /><br />
<?php else: ?>
