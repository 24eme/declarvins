...
<li><strong><?php echo $detail->sorties->vrac ?></strong> hl indiqué pour le produit <strong><?php echo $detail->getFormattedLibelle(ESC_RAW); ?></strong> : Contrat numéro : ______</li>
<?php endforeach; ?>
</ul>
