...
La plateforme CIEL de la Douane, nous indique que vous avez apporté des corrections à <a href="<?php echo ProjectConfiguration::getAppRouting()->generate('drm_visualisation', array('sf_subject' => $drm), true); ?>">votre DRM</a> du <strong><?php echo $drm->getMois() ?>/<?php echo $drm->getAnnee() ?>.<br /><br />
