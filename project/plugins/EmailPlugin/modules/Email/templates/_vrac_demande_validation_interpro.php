...
<strong>Si vous souhaitez valider ce contrat : </strong><a href="<?php echo ProjectConfiguration::getAppRouting()->generate('vrac_validation', array('sf_subject' => $vrac, 'acteur' => $acteur), true); ?>">Cliquez ici pour valider ou refuser le contrat</a>.<br /><br />
