...
Une DRM contenant des volumes sous surveillance, vient d'être validée : <a href="<?php echo ProjectConfiguration::getAppRouting()->generate('drm_visualisation', array('sf_subject' => $drm), true); ?>"><?php echo $drm->_id ?></a><br /><br />
