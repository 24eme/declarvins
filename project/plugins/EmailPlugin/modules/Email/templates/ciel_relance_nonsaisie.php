...
Nous vous contactons pour vous attirer votre attention sur le fait que vous n'avez pas saisie votre DRM. Elle aurait du l'être avant le 10 du mois.<br/>
Vous pouvez le faire en vous rendant dans votre <a href="https://declaration.declarvins.net/drm/<?php echo $etablissement->identifiant; ?>">espace DRM sur DéclarVins</a><br/><br/>
