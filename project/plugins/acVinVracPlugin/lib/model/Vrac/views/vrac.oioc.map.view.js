function(doc) {
	if (doc.type == "Vrac" && doc.valide.date_validation) {
		...
		var vrac_type_retiraison = (doc.type_retiraison)? doc.type_retiraison : null;
		...
		if (!vrac_addr_stockage_adresse) {
			vrac_addr_stockage_siret = doc.vendeur.siret;
			vrac_addr_stockage_adresse = doc.vendeur.adresse;
			vrac_addr_stockage_code_postal = doc.vendeur.code_postal;
			vrac_addr_stockage_commune = doc.vendeur.commune;
			vrac_addr_stockage_pays = doc.vendeur.pays;
		}
