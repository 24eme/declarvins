...
class VracRouting {
    ...
    static public function listenToRoutingLoadConfigurationEvent(sfEvent $event) {
        ...
        $r->prependRoute('vrac_pluriannuel', new sfRoute('/vrac/:identifiant/creation-adosse-pluriannuel',
        ...
        $r->prependRoute('vrac_edition', new VracRoute('/vrac/:identifiant/:contrat/edition',
                                                        ...
                                                        array('sf_method' => array('get','post')),
                                                        array('model' => 'Vrac', 'type' => 'object', 'no_archive' => true, 'segment_separators' => array('/'))));
        $r->prependRoute('vrac_etape', new VracRoute('/vrac/:identifiant/:contrat/etape/:step',
        ...
        $r->prependRoute('vrac_soussigne_getinfos', new VracRoute('/vrac/:contrat/getInfos',
                                                        array('module' => 'vrac','action' => 'getInformations'),
                                                        array('sf_method' => array('get')),
                                                        array('model' => 'Vrac', 'type' => 'object', 'segment_separators' => array('/'))));
        ...
        $r->prependRoute('vrac_soussigne_modification', new VracRoute('/vrac/:contrat/modification',
                                                        array('module' => 'vrac','action' => 'getModifications'),
                                                        array('sf_method' => array('get','post')),
                                                        array('model' => 'Vrac', 'type' => 'object', 'segment_separators' => array('/'))));

        $r->prependRoute('vrac_etablissement_informations', new VracRoute('/vrac/:identifiant/:contrat/etape/:step/informations/:soussigne/:type',
                                                        array('module' => 'vrac','action' => 'setEtablissementInformations'),
                                                        array('sf_method' => array('get','post')),
                                                        array('model' => 'Vrac', 'type' => 'object', 'segment_separators' => array('/'))));

        /*$r->prependRoute('vrac_produit_cvo', new VracRoute('/vrac/:identifiant/:contrat/produit/:hash/cvo',
...
//                                                        array('sf_method' => array('post')),
//                                                        array('model' => 'Vrac', 'type' => 'object')));
        $r->prependRoute('vrac_par_cvi_api', new sfRoute('/api/vrac/:cvi/:millesime/:epoch/:md5', array('module' => 'vrac', 'action' => 'apiContrats')));
        // /:epoch/:md5
    }
