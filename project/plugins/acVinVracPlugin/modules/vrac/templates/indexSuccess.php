...
<section id="contenu" class="vracs">
    ...
    <?php endif; ?>
        ...
        <ul class="nav nav-pills text-center" style="margin: 20px 0; justify-content: right; display: flex;">
            <?php if(!$pluriannuel): ?>
            <li style="padding: 0 5px; width: 120px;" class="<?php if($statut !== 0 && $statut !== VracClient::STATUS_CONTRAT_ATTENTE_ANNULATION && $statut !== VracClient::STATUS_CONTRAT_ATTENTE_VALIDATION): ?><?php else: ?>active<?php endif; ?>"><a href="<?php echo (!$etablissement)? url_for('vrac_admin') : url_for('vrac_etablissement', array('identifiant' => $etablissement->identifiant)); ?>?pluriannuel=<?php echo $pluriannuel ?>">En attente</a></li>
            <li style="padding: 0 5px; width: 120px;" class="<?php if($statut !== VracClient::STATUS_CONTRAT_NONSOLDE): ?><?php else: ?>active<?php endif; ?>"><a href="<?php echo (!$etablissement)? url_for('vrac_admin', array('statut' => VracClient::STATUS_CONTRAT_NONSOLDE)) : url_for('vrac_etablissement', array('identifiant' => $etablissement->identifiant, 'statut' => VracClient::STATUS_CONTRAT_NONSOLDE)); ?>?pluriannuel=<?php echo $pluriannuel ?>">Non soldé</a></li>
            <li style="padding: 0 5px; width: 120px;" class="<?php if($statut !== VracClient::STATUS_CONTRAT_SOLDE): ?><?php else: ?>active<?php endif; ?>"><a href="<?php echo (!$etablissement)? url_for('vrac_admin', array('statut' => VracClient::STATUS_CONTRAT_SOLDE)) : url_for('vrac_etablissement', array('identifiant' => $etablissement->identifiant, 'statut' => VracClient::STATUS_CONTRAT_SOLDE)); ?>?pluriannuel=<?php echo $pluriannuel ?>">Soldé</a></li>
            <li style="padding: 0 5px; width: 120px;" class="<?php if($statut !== VracClient::STATUS_CONTRAT_ANNULE): ?><?php else: ?>active<?php endif; ?>"><a href="<?php echo (!$etablissement)? url_for('vrac_admin', array('statut' => VracClient::STATUS_CONTRAT_ANNULE)) : url_for('vrac_etablissement', array('identifiant' => $etablissement->identifiant, 'statut' => VracClient::STATUS_CONTRAT_ANNULE)); ?>?pluriannuel=<?php echo $pluriannuel ?>">Annulé</a></li>
            <li style="padding: 0 5px; width: 120px;" class="<?php if($statut !== 'TOUS'): ?><?php else: ?>active<?php endif; ?>"><a href="<?php echo (!$etablissement)? url_for('vrac_admin', array('statut' => 'TOUS')) : url_for('vrac_etablissement', array('identifiant' => $etablissement->identifiant, 'statut' => 'TOUS')); ?>?pluriannuel=<?php echo $pluriannuel ?>">Tous</a></li>
            <?php endif; ?>
