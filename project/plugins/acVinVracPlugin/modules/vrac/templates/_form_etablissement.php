<div class="col">
    <div class="vracs_ligne_form ">
        <span>
            ...
            <?php echo $form['raison_sociale']->render(array('class' => 'disabled', 'disabled' => 'disabled')) ?>
        </span>
    </div>
    <div class="vracs_ligne_form vracs_ligne_form_alt">
        <span>
            ...
            <?php echo $form['siret']->render(array('class' => 'disabled', 'disabled' => 'disabled')) ?>
        </span>
    </div>
    <div class="vracs_ligne_form ">
        <span>
            ...
            <?php echo $form['adresse']->render(array('class' => 'disabled', 'disabled' => 'disabled')) ?>
        </span>
    </div>
    <div class="vracs_ligne_form vracs_ligne_form_alt">
        <span>
            ...
            <?php echo $form['commune']->render(array('class' => 'disabled', 'disabled' => 'disabled')) ?>
        </span>
    </div>
    <div class="vracs_ligne_form ">
        <span>
            ...
            <?php echo $form['code_postal']->render(array('class' => 'disabled', 'disabled' => 'disabled')) ?>
        </span>
    </div>
    <div class="vracs_ligne_form vracs_ligne_form_alt">
        <span>
            ...
            <?php echo $form['pays']->render(array('class' => 'disabled', 'disabled' => 'disabled')) ?>
        </span>
    </div>
</div>
<div class="col">
    <div class="vracs_ligne_form ">
        <span>
            ...
            <?php echo $form['nom']->render(array('class' => 'disabled', 'disabled' => 'disabled')) ?>
        </span>
    </div>
    <div class="vracs_ligne_form vracs_ligne_form_alt">
        <span>
            ...
            <?php echo $form['cvi']->render(array('class' => 'disabled', 'disabled' => 'disabled')) ?>
        </span>
    </div>
    <div class="vracs_ligne_form ">
        <span>
