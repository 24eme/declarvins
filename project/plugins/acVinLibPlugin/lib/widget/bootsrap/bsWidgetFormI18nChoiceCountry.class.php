...
/**
 * bsWidgetFormI18nChoiceCountry represents a country choice widget.
 *
 * @package    symfony
 * @subpackage widget
 ...
 */
class bsWidgetFormI18nChoiceCountry extends bsWidgetFormChoice
{
  /**
   * Constructor.
   *
   ...
   *
   * @see bsWidgetFormChoice & sfWidgetFormI18nChoiceCountry
   */
