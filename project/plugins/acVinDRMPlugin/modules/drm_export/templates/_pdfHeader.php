...
<tr>
   ...
   <td>N° DRM : <strong><?php echo preg_replace('/DRM-/', '', $drm->_id); ?></strong><?php if($drm->isValidee()): ?><br />(saisie <?php echo $drm->getModeDeSaisieLibelle() ?> le <strong><?php echo $drm->getEuValideDate(); ?></strong>)</td>
</tr>
<tr>
