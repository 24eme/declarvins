...
class DRMDroits extends BaseDRMDroits
{
    ...
    static $droit_sorties = array('sorties/vrac', 'sorties/vrac_export', 'sorties/vrac_sans_contrat', 'sorties/export', 'sorties/factures', 'sorties/crd', 'sorties/crd_acquittes');
