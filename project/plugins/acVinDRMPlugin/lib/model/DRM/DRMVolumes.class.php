...
class DRMVolumes
 {
  ...
  static $sorties_nettes = array('sorties/vrac', 'sorties/vrac_export', 'sorties/export', 'sorties/factures', 'sorties/crd', 'sorties/consommation', 'sorties/pertes');
