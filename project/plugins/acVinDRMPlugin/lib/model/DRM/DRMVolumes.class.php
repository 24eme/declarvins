...
class DRMVolumes
 {
  ...
  static $sorties_nettes = array('sorties/vrac', 'sorties/vrac_export', 'sorties/vrac_sans_contrat', 'sorties/export', 'sorties/factures', 'sorties/crd', 'sorties/consommation', 'sorties/pertes');
