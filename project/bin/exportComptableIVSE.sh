...
php symfony export:facture $SYMFONYTASKOPTIONS --interpro="INTERPRO-IVSE" > $TMP/factures.csv
...
php symfony export:facture-paiements $SYMFONYTASKOPTIONS --interpro="INTERPRO-IVSE" > $TMP/paiements.csv
