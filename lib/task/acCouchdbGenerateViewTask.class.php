...
class acCouchdbGenerateViewTask extends sfBaseTask {
    ...
    protected function configure() {
        ...
        $this->name = 'generate-view';
        $this->briefDescription = '';
        $this->detailedDescription = <<<EOF
The [acCouchdbGenerateView|INFO] task does things.
Call it with:

  [php symfony acCouchdbGenerateView|INFO]
EOF;
    }
