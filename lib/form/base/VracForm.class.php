...
class VracForm extends acCouchdbObjectForm 
{
	...
	public function configure()
    {
        ...
        $this->widgetSchema->setLabels(array(
        	...
        	'cas_particulier' => 'Cession interne:',
        	...
        	'date_limite_retiraison' => 'Date limite de facturation du solde total (au plus tard, dernière date de retiraison contractuelle):',
