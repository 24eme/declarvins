function(doc) {
    ...
    emit([doc.mandataire_identifiant, doc.valide.date_saisie, doc._id],  vue);
    emit([doc.acheteur_identifiant, doc.valide.date_saisie, doc._id], vue);
    emit([doc.vendeur_identifiant, doc.valide.date_saisie, doc._id], vue);
}