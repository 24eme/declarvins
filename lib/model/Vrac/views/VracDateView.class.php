...
class VracDateView extends acCouchdbView
{
	...
	const VALUE_DATE_LIMITE_RETIRAISON = 44;
	const VALUE_PAIEMENTS_DATE = 45;
	const VALUE_PAIEMENTS_VOLUME = 46;
	const VALUE_PAIEMENTS_MONTANT = 47;
	const VALUE_LOT_NUMERO = 48;
	const VALUE_LOT_ASSEMBLAGE = 49;
	const VALUE_LOT_CUVES_NUMERO = 50;
	const VALUE_LOT_CUVES_VOLUME = 51;
	const VALUE_LOT_CUVES_DATE = 52;
	const VALUE_LOT_MILLESIMES_ANNEE = 53;
