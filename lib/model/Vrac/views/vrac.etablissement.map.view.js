function(doc) { 
	if (doc.type == "Vrac" && doc.valide.date_validation) { 
		...
		if (doc.mandataire_identifiant) {
			emit([doc.mandataire_identifiant, doc.valide.date_validation, doc._id, doc.produit], vue);
		}
		emit([doc.acheteur_identifiant, doc.valide.date_validation, doc._id, doc.produit], vue);
		emit([doc.vendeur_identifiant, doc.valide.date_validation, doc._id, doc.produit], vue);
	} 
}