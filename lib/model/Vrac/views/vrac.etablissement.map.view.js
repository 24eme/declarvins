function(doc) { 
	if (doc.type == "Vrac" && doc.valide.date_saisie) { 
		...
		var vrac_commentaire = doc.commentaires;
		...
		if (doc.mandataire_identifiant) {
			emit([doc.mandataire_identifiant, doc.valide.date_saisie, doc._id, doc.produit], vue);
		}
		emit([doc.acheteur_identifiant, doc.valide.date_saisie, doc._id, doc.produit], vue);
		emit([doc.vendeur_identifiant, doc.valide.date_saisie, doc._id, doc.produit], vue);
	} 
}