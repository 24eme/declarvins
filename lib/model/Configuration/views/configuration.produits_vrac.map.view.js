        ...
        for (g in doc.declaration.certifications[c].genres) {
    			...
    			if (nb > 0) {
		        	...
		        	for (i in doc.declaration.certifications[c].genres[g].interpro)
		        	{
		        		...
		        		if (doc.declaration.certifications[c].genres[g].interpro[i].hasOwnProperty("droits"))
		        		{
		        			...
		        			{
		        				if (doc.declaration.certifications[c].genres[g].interpro[i].droits.cvo[doc.declaration.certifications[c].genres[g].interpro[i].droits.cvo.length - 1].taux) {
            ...
            for (a in doc.declaration.certifications[c].genres[g].appellations) {
        			...
        			if (nb > 0) {
		            	...
		            	for (i in doc.declaration.certifications[c].genres[g].appellations[a].interpro)
		            	{
		            		...
		            		if (doc.declaration.certifications[c].genres[g].appellations[a].interpro[i].hasOwnProperty("droits"))
		            		{
		            			...
		            			{
		            				if (doc.declaration.certifications[c].genres[g].appellations[a].interpro[i].droits.cvo[doc.declaration.certifications[c].genres[g].appellations[a].interpro[i].droits.cvo.length - 1].taux) {
                ...
                for (m in doc.declaration.certifications[c].genres[g].appellations[a].mentions) {
        				...
        				if (nb > 0)
        				{
        		        	...
        		        	for (i in doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].interpro)
        		        	{
        		        		...
        		        		if (doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].interpro[i].hasOwnProperty("droits"))
        		        		{
        		        			...
        		        			{
        		        				if (doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].interpro[i].droits.cvo[doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].interpro[i].droits.cvo.length - 1].taux) {
	            			...
	            			if (nb > 0)
	            			{
			                	...
			                	for (i in doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].interpro)
			                	{
			                		...
			                		if (doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].interpro[i].hasOwnProperty("droits"))
			                		{
				            			...
				            			{
				            				if (doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].interpro[i].droits.cvo[doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].interpro[i].droits.cvo.length - 1].taux) {
	                                ...
	                                for(array_dep_key in dep) {
	                                    if (dep[array_dep_key].length > 0) {
	                                        for(d in dep[array_dep_key]) {
	                                            emit(["lieux", c, dep[array_dep_key][d], hash, hash, codes.join('')], {libelles: libes, codes: codesv});
	                                        }
	                                        break;
	                                    }
	                                }
				  ...
				  if (doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].hasOwnProperty("interpro"))
				  {
					  nb = 0;
					  for (item in doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].interpro) {
						  nb = nb + 1;
					  }
					  if (nb > 0)
					  {
						  interprosCouleur = new Array();
						  for (i in doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].interpro)
						  {
							  interprosCouleur[i] = new Array();
							  interprosCouleur[i]["cvo"] = new Array();
							  if (interprosCouleur.hasOwnProperty(i))
							  {
								  interprosCouleur[i]["cvo"] = interprosLieu[i]["cvo"];
							  }
							  if (doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].interpro[i].hasOwnProperty("droits"))
							  {
								  if (doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].interpro[i].droits.hasOwnProperty("cvo") && doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].interpro[i].droits.cvo.length > 0) 
								  {
									  if (doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].interpro[i].droits.cvo[doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].interpro[i].droits.cvo.length - 1].taux) {
										  interprosCouleur[i]["cvo"] = doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].interpro[i].droits.cvo[doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].interpro[i].droits.cvo.length - 1];
									  }
								  }
							  }
						  }
				  ...
				  // /JB
	                        ...
	                        for(ce in doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].cepages) {
	                            ...
	                            var cepageHasVrac = doc.declaration.certifications[c].genres[g].appellations[a].mentions[m].lieux[l].couleurs[co].cepages[ce].has_vrac;
				    for(i in inter) {
	                                if (inter[i].length > 0) {
	                                    for(array_intepro_key in inter) {
	                                        for(array_dep_key in dep) {
	                                            if (dep[array_dep_key].length > 0) {
	                                                for(d in dep[array_dep_key]) {
	                                                    emit(["produits", cepageHasVrac, dep[array_dep_key][d], hash_lieu, hash, codes.join('')], {libelles: libes, codes: codesv, cvo: interprosCouleur[inter[i]]["cvo"]});
	                                                }
	                                                break;
	                                            }
	                                        }
