			        ...
			        if (appellation_code == key_default) {
				        ...
				        if (couleur_code == key_default) {
					        	...
					        	cepage_libelle = null;
			                            ...
			                            for(detail_key in cepage.details) {
			                                ...
			                                if (isNaN(montant_cvo)) {
			                                	...
			                                	montant_cvo = montant_cvo.toFixed(2);
			                                }
							...
							if (nb_labels > 0) {
			                                ...
			                                emit([doc.interpros[interpro], detail.has_vrac, doc.valide.date_saisie, detail.has_vrac, doc._id, detail_hash], 
			                                		[key,
			                                		 drm_identifiant,
			                                		 drm_declarant,
			                                		 drm_annee,
			                                ...
			                                var nb_vracs = (detail.vrac).length;
			                                if (nb_vracs > 0) {
				                                for (numero_vrac in detail.vrac) {
				                                	var volume_vrac = detail.vrac[numero_vrac].volume;
				                                	emit([doc.interpros[interpro], doc.valide.date_saisie, detail.has_vrac, doc._id, detail_hash], 
					                                		[key_vrac,
					                                		 null,
					                                		 null,
					                                		 null,
