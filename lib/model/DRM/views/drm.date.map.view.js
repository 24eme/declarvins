			        ...
			        if (appellation_code == key_default) {
				        ...
				        if (couleur_code == key_default) {
							...
							if (nb_labels > 0) {
			                                ...
			                                emit([doc.interpros[interpro], doc.periode+'-01', detail.has_vrac, doc._id, detail_hash, "PRODUIT"], 
			                                		[key,
			                                		 drm_identifiant,
			                                		 drm_declarant,
			                                		 drm_annee,
			                                ...
			                                if (nb_vracs > 0) {
				                                for (numero_vrac in detail.vrac) {
				                                	...
				                                	emit([doc.interpros[interpro], doc.periode+'-01', detail.has_vrac, doc._id, detail_hash, "VRAC"], 
					                                		[key_vrac,
					                                		 drm_identifiant,
					                                		 drm_declarant,
					                                		 drm_annee,
