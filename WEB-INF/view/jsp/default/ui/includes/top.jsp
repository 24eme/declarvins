...
<head>
        <title>La plateforme d'authentification des vins du Rhône, de Provence et du Sud Est</title>
        ...
        <meta name="copyright" content="DéclarWeb - 2011" />
...
<!-- ####### A REPRENDRE ABSOLUMENT ####### -->
        ...
        <div id="global">
                ...
                <!-- #header -->
                <header id="header">
                        <h1>La plateforme d'authentification des vins du Rhône, de Provence et du Sud Est</h1>
                </header>
                <!-- fin #header -->
